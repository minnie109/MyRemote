...
if ($id <=0) {
	...
	$sql = "select jobName, jobUrgent, jobContent, state from todo where id=?;"; 
...
<input type="button" onClick="postForm1()" value="送出" >
<input type="button" onClick="postForm2()" value="刪除" >
